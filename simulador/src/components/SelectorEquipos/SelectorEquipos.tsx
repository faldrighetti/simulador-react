    ...
    leagues: [
      {
        ...
        teams: [
          ...
          { name: "Granada", logo: getTeamLogoPath("Granada"), media: 70 },
          { name: "Alavés", logo: getTeamLogoPath("Alavés"), media: 72 },
          { name: "Espanyol", logo: getTeamLogoPath("Espanyol"), media: 70 },
          { name: "Almería", logo: getTeamLogoPath("Almería"), media: 69 },
          { name: "Girona", logo: getTeamLogoPath("Girona"), media: 76 },
          { name: "Real Valladolid", logo: getTeamLogoPath("Real Valladolid"), media: 71 },
          { name: "Sporting Gijón", logo: getTeamLogoPath("Sporting Gijón"), media: 70 },
      ...
      },
      {
        ...
        categoria: 2,
        teams: [
          { name: "Celta de Vigo", logo: getTeamLogoPath("Celta de Vigo"), media: 75 },
          { name: "Osasuna", logo: getTeamLogoPath("Osasuna"), media: 74 },
          { name: "Mallorca", logo: getTeamLogoPath("Mallorca"), media: 73 },
          ...
          { name: "Levante", logo: getTeamLogoPath("Levante"), media: 72 },
          ...
          { name: "Real Oviedo", logo: getTeamLogoPath("Real Oviedo"), media: 72 },
    ...
    leagues: [
      {
        ...
        teams: [
          ...
          { name: "Wolverhampton", logo: getTeamLogoPath("Wolverhampton"), media: 74 },
          { name: "Everton", logo: getTeamLogoPath("Everton"), media: 73 },
          { name: "Bournemouth", logo: getTeamLogoPath("Bournemouth"), media: 73 },
          { name: "Sheffield United", logo: getTeamLogoPath("Sheffield United"), media: 68 },
          { name: "Cardiff City", logo: getTeamLogoPath("Cardiff City"), media: 71 },
          { name: "Leicester City", logo: getTeamLogoPath("Leicester City"), media: 75 },
          { name: "Watford", logo: getTeamLogoPath("Watford"), media: 72 },
      ...
      },
      {
        ...
        categoria: 2,
        teams: [
          { name: "Brentford", logo: getTeamLogoPath("Brentford"), media: 75 },
          { name: "Nottingham Forest", logo: getTeamLogoPath("Nottingham Forest"), media: 73 },
          { name: "Burnley", logo: getTeamLogoPath("Burnley"), media: 70 },
          ...
          { name: "Sunderland", logo: getTeamLogoPath("Sunderland"), media: 72 },
