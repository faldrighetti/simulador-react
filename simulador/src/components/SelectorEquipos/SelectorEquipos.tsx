    ...
    leagues: [
      {
        ...
        teams: [
          ...
          { name: "Argentinos Juniors", logo: getTeamLogoPath("Argentinos Juniors"), media: 75 },
          { name: "Atlético Tucumán", logo: getTeamLogoPath("Atlético Tucumán"), media: 68 },
          { name: "Banfield", logo: getTeamLogoPath("Banfield"), media: 71 },
          { name: "Barracas Central", logo: getTeamLogoPath("Barracas Central"), media: 66 },
          ...
          { name: "Deportivo Riestra", logo: getTeamLogoPath("Deportivo Riestra"), media: 68 },
          { name: "Estudiantes (LP)", logo: getTeamLogoPath("Estudiantes (LP)"), media: 77 },
          { name: "Estudiantes (Río Cuarto)", logo: getTeamLogoPath("Estudiantes (Río Cuarto)"), media: 66 },
          { name: "Gimnasia (LP)", logo: getTeamLogoPath("Gimnasia (LP)"), media: 72 },
          { name: "Gimnasia (Mza)", logo: getTeamLogoPath("Gimnasia (Mza)"), media: 69 },
          { name: "Huracán", logo: getTeamLogoPath("Huracán"), media: 75 },
          { name: "Independiente", logo: getTeamLogoPath("Independiente"), media: 73 },
          { name: "Independiente Rivadavia", logo: getTeamLogoPath("Independiente Rivadavia"), media: 76 },
          ...
          { name: "Platense", logo: getTeamLogoPath("Platense"), media: 74 },
          { name: "Racing Club", logo: getTeamLogoPath("Racing Club"), media: 78 },
          { name: "River Plate", logo: getTeamLogoPath("River Plate"), media: 81 },
          { name: "Rosario Central", logo: getTeamLogoPath("Rosario Central"), media: 77 },
          { name: "San Lorenzo", logo: getTeamLogoPath("San Lorenzo"), media: 75 },
    ...
    leagues: [
      {
        ...
        teams: [
          ...
          { name: "Atlético Madrid", logo: getTeamLogoPath("Atlético Madrid"), media: 86 },
    ...
    leagues: [
      {
        ...
        teams: [
          ...
          { name: "Paris Saint-Germain", logo: getTeamLogoPath("Paris Saint-Germain"), media: 90 },
    ...
    leagues: [
      {
        ...
        categoria: 1,
        teams: [
          { name: "Manchester City", logo: getTeamLogoPath("Manchester City"), media: 88 },
          { name: "Liverpool", logo: getTeamLogoPath("Liverpool"), media: 87 },
          { name: "Arsenal", logo: getTeamLogoPath("Arsenal"), media: 87 },
